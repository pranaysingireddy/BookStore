...
namespace BookStore.Services.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(BookStoreContext context, IOptions<JWTSettings> jwtsettings)
        {
            _context = context;
        ...
        // POST: api/Users
        [HttpPost("Login")]
        public async Task<ActionResult<UserWithToken>> Login([FromBody] LoginUserViewModel user)
        {
            var userInDb = await _context.User.Include(u => u.Role)
            ...
            if (userInDb != null)
            {
                ...
                userWithToken = new UserWithToken(userInDb);
            ...
            userWithToken.AccessToken = GenerateAccessToken(userInDb.UserId);
        ...
        private RefreshToken GenerateRefreshToken()
        {
            ...
            refreshToken.ExpiryDate = DateTime.UtcNow.AddHours(8);
